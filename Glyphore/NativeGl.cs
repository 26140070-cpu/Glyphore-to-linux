...
internal static class NativeGl
{
    ...
    public static PIXELFORMATDESCRIPTOR DefaultPfd() =>
        throw new PlatformNotSupportedException("NativeGl.DefaultPfd requires WinForms/WGL.");

    [Obsolete("WGL is not available on Avalonia/Linux."), EditorBrowsable(EditorBrowsableState.Never)]
    public static IntPtr GetDC(IntPtr hWnd) =>
        throw new PlatformNotSupportedException("NativeGl.GetDC requires WinForms/user32.");

    [Obsolete("WGL is not available on Avalonia/Linux."), EditorBrowsable(EditorBrowsableState.Never)]
    public static int ReleaseDC(IntPtr hWnd, IntPtr hDc) =>
        throw new PlatformNotSupportedException("NativeGl.ReleaseDC requires WinForms/user32.");

    [Obsolete("WGL is not available on Avalonia/Linux."), EditorBrowsable(EditorBrowsableState.Never)]
    public static int ChoosePixelFormat(IntPtr hdc, ref PIXELFORMATDESCRIPTOR ppfd) =>
        throw new PlatformNotSupportedException("NativeGl.ChoosePixelFormat requires WinForms/gdi32.");

    [Obsolete("WGL is not available on Avalonia/Linux."), EditorBrowsable(EditorBrowsableState.Never)]
    public static bool SetPixelFormat(IntPtr hdc, int format, ref PIXELFORMATDESCRIPTOR ppfd) =>
        throw new PlatformNotSupportedException("NativeGl.SetPixelFormat requires WinForms/gdi32.");

    [Obsolete("WGL is not available on Avalonia/Linux."), EditorBrowsable(EditorBrowsableState.Never)]
    public static bool SwapBuffers(IntPtr hdc) =>
        throw new PlatformNotSupportedException("NativeGl.SwapBuffers requires WinForms/gdi32.");

    [Obsolete("WGL is not available on Avalonia/Linux."), EditorBrowsable(EditorBrowsableState.Never)]
    public static IntPtr wglCreateContext(IntPtr hdc) =>
        throw new PlatformNotSupportedException("NativeGl.wglCreateContext requires WinForms/WGL.");

    [Obsolete("WGL is not available on Avalonia/Linux."), EditorBrowsable(EditorBrowsableState.Never)]
    public static bool wglDeleteContext(IntPtr hglrc) =>
        throw new PlatformNotSupportedException("NativeGl.wglDeleteContext requires WinForms/WGL.");

    [Obsolete("WGL is not available on Avalonia/Linux."), EditorBrowsable(EditorBrowsableState.Never)]
    public static bool wglMakeCurrent(IntPtr hdc, IntPtr hglrc) =>
        throw new PlatformNotSupportedException("NativeGl.wglMakeCurrent requires WinForms/WGL.");

    [Obsolete("Use ClearColor proc loaded via Load(getProcAddress)."), EditorBrowsable(EditorBrowsableState.Never)]
    public static void glClearColor(float r, float g, float b, float a) => ClearColor(r, g, b, a);

    [Obsolete("Use Clear proc loaded via Load(getProcAddress)."), EditorBrowsable(EditorBrowsableState.Never)]
    public static void glClear(uint mask) => Clear(mask);
}
