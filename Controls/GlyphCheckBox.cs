...
internal sealed class GlyphCheckBox : CheckBox
{
    ...
    public GlyphCheckBox()
    {
        ...
        LinuxControlInitialization.Defer(this, () => Cursor = Cursors.Hand, nameof(Cursor));
        SetStyle(ControlStyles.UserPaint | ControlStyles.AllPaintingInWmPaint | ControlStyles.OptimizedDoubleBuffer, true);
        CheckedChanged += HandleVisualStateChanged;
        EnabledChanged += HandleVisualStateChanged;
    }
    ...
    private void HandleVisualStateChanged(object? sender, EventArgs e) => Invalidate();
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        ...
        if (Checked)
        {
            ...
            {
                StartCap = Majorsilence.Forms.Drawing.Drawing2D.LineCap.Round,
                EndCap = Majorsilence.Forms.Drawing.Drawing2D.LineCap.Round
            };
