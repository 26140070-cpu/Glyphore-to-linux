...
/// <summary>
/// Small WinForms API-compatibility layer for GTKSystem.Windows.Forms.
/// It keeps the Windows control surface used by Glyphore while mapping
/// unsupported WinForms-only convenience APIs to GTK-safe behavior.
/// </summary>
...
internal class CompatRichTextBox : System.Windows.Forms.RichTextBox
{
    ...
    {
        // GTK text views keep their own scroll position. Focus is enough to
        // bring the caret into view on supported backends.
        try { Focus(); } catch { }
    }
